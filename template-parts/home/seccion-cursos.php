          ...
          <div class="swiper-slide pb-8">
            <a href="<?php echo $cta_url; ?>" class="d-block p-8 bg-white rounded shadow" title="<?php echo $titulo; ?>"
              ...
              <div class="px-18 py-8">
                ...
                <?php } ?>
                <?php if ($categoria) { ?>
                  <p class="d-inline-block fs-p-small bg-yellow-100 text-yellow-900 px-8 rounded-4 fw-bold">
                    <?php echo $categoria; ?></p>
                <?php } ?>

                <div class="d-flex p-8 gap-18 bg-gray-50 rounded">
                  <p class="d-flex align-center gap-4 fs-p-small mb-0"><i
                      class="icono icono-usuario"></i><?php echo $autor; ?></p>
                  <p class="d-flex align-center gap-4 fs-p-small mb-0"><i
                      class="icono icono-calendario"></i><?php echo $clases; ?></p>
                  <p class="d-flex align-center gap-4 fs-p-small mb-0"><i
                      class="icono icono-hora"></i><?php echo $hora; ?></p>
                </div>
              </div>
            </a>
          </div>
  ...
  <?php if ($ver_mas_url) { ?>
    <div class="container">
      <div class="text-right">
        <a class="d-flex align-center justify-end font-titulo text-black" href="<?php echo $ver_mas_url; ?>"
          target="<?php echo $ver_mas_target; ?>" title="<?php echo $ver_mas_titulo; ?>">
