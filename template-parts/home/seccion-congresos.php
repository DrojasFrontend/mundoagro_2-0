...
$cta_target = !empty($cta['target']) ? esc_url($cta['target']) : '';
?>
            ...
            <div class="col-12">
                <div class="p-8 bg-white rounded shadow">
                    ...
                    <div class="p-18 pt-0">
                        ...
                        <?php if ($descripcion): ?>
                            <p class="fs-p"><?php echo esc_html($descripcion); ?></p>
                        <?php endif; ?>

                        <?php if ($fecha): ?>
                            <p class="d-flex align-center fs-p mb-8">
                                <i class="icono icono-calendario"></i><?php echo esc_html($fecha); ?>
                            </p>
                        <?php endif; ?>

                        <?php if ($lugar): ?>
                            <p class="d-flex align-center fs-p mb-24">
