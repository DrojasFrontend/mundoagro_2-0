  ...
  <div class="row">
    <div class="col-12 col-lg-12 col-xl-9">
      ...
      <?php 
        ...
        $imagen_principal     = get_the_post_thumbnail_url($noticia_principal->ID, 'full');
      ?>
      <article class="row mb-18">
        <div class="col-12 col-lg-6 pe-xl-0">
          <div class="w-100 h-100">
            <img class="w-100 h-100 object-fit-cover" src="<?php echo $imagen_principal; ?>" alt="">
          </div>
        </div>
        <div class="col-12 col-lg-6 pe-xl-0">
          <h1 class="mb-18">
        ...
        <div class="col-12 col-lg-8 pe-xl-0">
          <div class="d-grid grid-cols-3 gap-18">
            <?php foreach ($noticias as $noticia) { 
              ...
              $imagen_url = get_the_post_thumbnail_url($noticia->ID, 'full');
              ?>
              <article class="col-12 noticiaDestacadas">
                <div class="w-100">
                  <img class="w-100 d-flex object-fit-cover" src="<?php echo $imagen_url; ?>" alt="">
                </div>
                <h2 class="fw-bold mb-18">
                  <?php echo $titulo; ?>
                </h2>
