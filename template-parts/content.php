...
?>
    ...
    <main class="mt-50">
        <div class="container with-sidebar single-content">
            <div class="content align-to-logo ">
                <!-- HEADER ARTICULO -->
                <div class="entry-headermb-30">
                    ...
                    <div class="entry-date text-uppercase mb-30"><?php the_time('F j, Y') ?></div>
                ...
                <figure class="image mb-30 m-auto text-center border-radius-2">
                    <?php echo get_the_post_thumbnail(get_the_ID(), 'featured-img'); ?>
                ...
                <article class="entry-wraper mb-50">
                    <div class="entry-share-container ">
                        <div class="entry-fixed-container">
                            <div class="fixed-author text-center meta-2 font-small">
                                <div class="author-box">
                                    ...
                                    <div class="author-content mt-10">
                                        <a href="javascript:void(0);" rel="author"><span class="author-name text-uppercase font-weight-bold color-black">
                                ...
                                <!-- second and more author -->
                              <?php foreach([2, 3, 4, 5, 6, 7, 8] as $index): ?>
                                <?php if (get_field('autor_' . $index) and (get_field('autor_'.$index)['nombre_autor'] != '')): ?>
                                <div class="author-box mt-4">
                                    <a class="author-avatar" href="#">
                                        <?php $thb_id = get_the_author_meta('ID'); 
                                          if (get_field('autor_'.$index) and (get_field('autor_'.$index)['nombre_autor'] != '')): ?>
                                                <!-- Nombre del autor no mundoagro -->
                                                <?php $image =  get_field('autor_'.$index)['foto_autor'];
                                                    $size = 'thumbnail';
                                                    $thumb = $image['sizes'][ $size ];
                                                    $width = $image['sizes'][ $size . '-width' ];
                                                    $height = $image['sizes'][ $size . '-height' ];
                                    ...
                                    <div class="author-content mt-10">
                                        <a href="javascript:void(0);" rel="author"><span class="author-name text-uppercase font-weight-bold color-black">
                                            <?php if (get_field('autor_'.$index)): ?>
                                            <!-- Nombre del autor no mundoagro -->
                                            <span class="name"><?php echo get_field('autor_'.$index)['nombre_autor']; ?></span>
                                            <?php else: ?>
                                                <span class="name"><?php the_author_meta( 'display_name', $thb_id ); ?></span>
                                            <?php endif; ?>
                                        </span></a>
                                        ...
                                        <?php if (get_field('autor_'.$index)): ?>
                                        <!-- Nombre del autor no mundoagro -->
                                        <span class="name"><?php echo get_field('autor_'.$index)['descripcion_autor']; ?></span>
                                        <?php else: ?>
                                            <?php the_author_meta( 'description', $thb_id ); ?>
                                        <?php endif; ?>
                                        </p>
                            ...
                            <div class="fixed-share text-center"></div>
                        </div>
                        ...
                        <div class="entry-main-content dropcap wow fadeIn animated">
                            ...
                            <!--Begin Subcrible-->
                            <div class="border-radius-5 mb-50 border p-30 wow fadeIn animated d-none">
                    ...
                    <?php foreach([2, 3, 4, 5, 6, 7, 8] as $index): ?>
                        <?php if (get_field('autor_' . $index) and (get_field('autor_'.$index)['nombre_autor'] != '')): ?>
                        <div class="author-bio wow fadeIn animated mt-4">
                            <div class="author-image">
                                <!-- Nombre del autor no mundoagro -->
                                <?php $image =  get_field('autor_'.$index)['foto_autor'];
                                    $size = 'thumbnail';
