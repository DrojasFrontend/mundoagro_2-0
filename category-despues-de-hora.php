<?php
/**
* Despues de Hora Category Template
*/
            ...
            <div class="mb-30">
                ...
                while ( have_posts() ) : the_post(); ?>
                    <article class="col-xl-3 col-md-6 mb-15 mt-15 wow fadeIn animated">
                        ...
                        <?php if (get_field('persona', get_the_ID())): ?>
                        <span class="post-personaje font-italic">
                            <?php
                            echo get_field('persona', get_the_ID());
                            echo ' - ';
                            echo get_field('cargo-dh', get_the_ID());
                            ?>
                        </span>
                        <?php endif; ?>
